        ...
        <div className="bg-white rounded-xl shadow-sm p-8 space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              <a href="mailto:info@optigridtech.net" className="text-blue-600">info@optigridtech.net</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              Email:{' '}
              <a href="mailto:info@optigridtech.net" className="text-blue-600">info@optigridtech.net</a><br />
              Ιστότοπος:{' '}
