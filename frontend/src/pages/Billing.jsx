    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-md mx-auto p-6">
        ...
        <div className="bg-white p-6 rounded shadow">
          ...
          <p className="mb-6 text-gray-600 text-sm">€15/μήνα · Ακύρωση οποιαδήποτε στιγμή</p>
          {status === 'active'
            ? <button onClick={manage} className="w-full bg-gray-200 py-2 rounded">Διαχείριση Συνδρομής</button>
            : <button onClick={subscribe} className="w-full bg-blue-700 text-white py-2 rounded font-semibold">Εγγραφή — €15/μήνα</button>
          }
        </div>
      </div>
    </div>
